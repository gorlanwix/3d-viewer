...
var cubeTexture = THREE.ImageUtils.loadTexture('../models/textures/box.png');
var materials = [];
...
loader.load('../models/bird.js', function (geometry, materials) {
	...
	item = new THREE.Mesh(new THREE.BoxGeometry(100, 10, 10), new THREE.MeshBasicMaterial({ color: 0xff0000 }));
	item.position.x = 50;
